...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    public ViewProductDetailJPanel(JPanel workArea, Product product, SupplierDirectory supplierDirectory) {
        ...
        refreshTable();
        popupExistingFeatures();
    }

    private void popupExistingFeatures() {
existingFeatures.removeAllItems();
      for(Supplier s : supplierDirectory.getSupplierList()){
          for(Product p : s.getProductCatalog().getProductCatalog()){
              for(Feature f: p.getFeatures()){
                  existingFeatures.addItem(f.getName());
              }
          }
      }
    }
    ...
    private void initComponents() {
        ...
        existingFeatures = new javax.swing.JComboBox<>();
        ...
        jLabel1.setText("Add existing feature:");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(existingFeatures, javax.swing.GroupLayout.PREFERRED_SIZE, 324, javax.swing.GroupLayout.PREFERRED_SIZE)))
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(existingFeatures, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnAdd)
                            .addComponent(jLabel1))
                        .addGap(35, 35, 35)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
Component component;
 ...
 popupExistingFeatures();
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        // TODO add your handling code here:
        Feature newFeature = product.addNewFeature();
        newFeature.setName(String.valueOf(existingFeatures.getSelectedItem()));
        newFeature.setValue("Type Value here");
    ...
    private javax.swing.JComboBox<String> existingFeatures;
